...
<body>
	...
	<div class="row p-4">
		...
		<div class="col border-left">
			<h2 class="border-bottom">Product Catalog Add</h2>
			...
			<div class="row">
				<div class="col">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="row py-2">
							...
							<div class="col">
								<textarea rows="3" class="form-control" name="product_desc" cols="100" maxlength="100" placeholder="Max 100 characters."></textarea>
							</div>
						</div>
				...
				<div class="col py-2">
					<img src="#" alt="Preview product image here." id="preview" width="350" style="border: 1px solid #ddd; border-radius: 4px;padding: 5px;">
				</div>
			</div>
		</div>
